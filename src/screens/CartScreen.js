...
import ProductCard from "./Components/CartScreenComponents/ProductCard";

const CartScreen = () => {
  const cartItem = useCartStore((state) => state.cartData);
  const currentAmnt = useCartStore((state) => state.currentAmt);
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row  p-2 sm:p-0 justify-center w-auto h-auto gap-6 md:gap-64 mb-10">
          ...
          <form className="flex flex-col p-4 " action="">
            <div className="flex flex-col mt-4 ">
              ...
              <input
                ...
                className="border mt-1 h-10 rounded px-4"
              />
              <input
                type="text"
                name="lName"
            ...
            <div className="flex flex-col mt-4">
              ...
              <input
                ...
                name="area"
                id=""
                placeholder="Society / Area / village"
                className="border mt-1 h-10 rounded px-4"
              />
            </div>
            <div className="flex flex-col mt-4">
        ...
        {/* Right section div */}
        <div>
          <h3 className="font-semibold text-3xl text-stone-800 mt-8 text-center">
            Your Cart
          </h3>
          <div className="border  p-8   bg-white rounded ">
            ...
            {cartItem.map((e, i) => {
              return <ProductCard data={e} index={i} key={i} />;
            })}
            ...
            <div className="mt-8">
              <p className="flex w-auto justify-between">
                SubTotal <p className="">₹ {currentAmnt}</p>
              </p>
              ...
              <p className="mt-2 flex ">
                ...
                <p className="ml-auto">₹ {currentAmnt}</p>
              </p>
            </div>
